...
/// <summary>
/// A representation of the completion status of a function.
/// </summary>
    ...
    IFormattable
{
    ...
    private const uint S_MASK = 0b_10000000_00000000_00000000_00000000;
    
    //  - Reserved; corresponds to NTSTATUS's second severity bit (1 - Severe Failure).
    private const uint R_MASK = 0b_01000000_00000000_00000000_00000000;
    
    // C - Customer; specifies whether the value is Microsoft-defined (0) or customer-defined (1).
    private const uint C_MASK = 0b_00100000_00000000_00000000_00000000;
    
    // N - Reserved; used to indicate an NTSTATUS value that has been mapped to a HRESULT.
    private const uint N_MASK = 0b_00010000_00000000_00000000_00000000;
    
    // X - Reserved for internal use; used to indicate a value that is not a status but is instead a message ID for display strings.
    private const uint X_MASK = 0b_00001000_00000000_00000000_00000000;
    
    // Facility - indicates the system service that is responsible for the status.
    private const uint FACILITY_MASK = 0b_00000111_11111111_00000000_00000000;
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => (Facility)((_hresult >> 16) & 0b_111_11111111);
    }
    ...
    public Uri InfoUri => new($"https://www.hresult.info/Search?q=0x{_hresult:X8}");
    ...
    public string ToString(string? format, IFormatProvider? provider = null)
    {
        return format switch
        {
            "X" => $"0x{_hresult:X8}",
            "x" => $"0x{_hresult:x8}",
            "I" or "i" => (unchecked((int)_hresult)).ToString(null, provider),
            "U" or "u" => _hresult.ToString(null, provider),
            _ => ToString(),
        };
    }
