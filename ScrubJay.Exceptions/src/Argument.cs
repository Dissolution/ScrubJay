...
public sealed record class Argument
{
    ...
    public static Argument Create<T>(string? name, ref readonly T? value)
    ...
    public static Argument Create<T>(ref readonly T? value, [CallerArgumentExpression(nameof(value))] string? argumentName = null)
#if NET9_0_OR_GREATER
        where T : allows ref struct
#endif
