...
//
//namespace ScrubJay.Memory.ARCHIVE;
//
//[PublicAPI]
...
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        internal set => _position = Math.Clamp(value, 0, Capacity);
//    }
//
...
//        }
//
//        throw new InvalidOperationException($"Could not write item '{item}': No capacity remaining");
//    }
//
...
//        else
//        {
//            throw new ArgumentException($"Could not write {items.Length} items: Only {RemainingCount} capacity remains", nameof(items));
//        }
//    }
//
//
