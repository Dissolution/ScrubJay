...
//    /// </summary>
//    public static TypeDictionary<int> ErrorTypeToHttpStatusCodeMap { get; } = new()
//    {
...
//        set
//        {
//            if (value is < 100 or >= 600)
//                throw ArgRangeException.Create(value, "was not a valid Http Status Code between 100 and 599");
//            field = value;
//        }
...
//        {
//            Type = exception.GetTypeURN().ToString(),
