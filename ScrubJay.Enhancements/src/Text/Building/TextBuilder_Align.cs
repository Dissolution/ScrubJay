...
//                _charArray[start] = '…';
//                // copy and trim
//                var chunk = _charArray.AsSpan(start, len)[^(width - 1)..];
//                Debug.Assert(width - 1 == chunk.Length);
//                TextHelper.Notsafe.CopyBlock(chunk, _charArray.AsSpan(start + 1), width - 1);
//
//                _position = start + width;
//                return this;
//            }
...
//                    return Append("……");
//
//                var wrote = _charArray.AsSpan(start, len);
//
