...
public class Any_ToString_Tests_NoToString0
{
    [Theory]
    ...
    {
        string str = Any.ToString<int>(in i32, default);
        Assert.NotNull(str);
    ...
    {
        string? anystr = Any.ToString<string>(in str, default);
    ...
    {
        string str = Any.ToString<char>(in ch, default);
        Assert.NotNull(str);
    ...
    public void CanToStringText()
    {
        ...
        text = default;
        str = Any.ToString<ReadOnlySpan<char>>(in text, default);
        Assert.NotNull(str);
    ...
    public void Any_ToString_TestRefStruct_Works()
    {
        ...
        string? anyStr = Any.ToString(in instance, default);
        Assert.NotNull(anyStr);
        string? str = $"{Type.Render<TestRefStruct>()} instance";
        //string? str = instance.ToString();
        Assert.Equal(str, anyStr);
    }
    ...
    public void Any_ToString_TestReadonlyRefStruct_Works()
    {
        ...
        string? anyStr = Any.ToString(in instance, default);
        Assert.NotNull(anyStr);
        string? str = $"{Type.Render<TestReadonlyRefStruct>()} instance";
        //string? str = instance.ToString();
        Assert.Equal(str, anyStr);
    }
